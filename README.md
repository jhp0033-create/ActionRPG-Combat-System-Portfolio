...
## 12. 사용 리소스 출처 (Resource Credits)

본 프로젝트는 개인 포트폴리오 기술 검증 목적으로 제작된 비상업적 프로토타입입니다. 지원 직무의 레퍼런스 게임 톤과 전투 피드백을 참고해 작업했으며, 인게임 구현의 시각적/청각적 피드백을 확인하기 위해 활용한 외부 에셋의 출처는 다음과 같습니다.
